...
export default function PaymentDeclarationPage() {
  ...
  const membershipPrice = Number.isNaN(
    numericPrice
  )
    ? 0
    : numericPrice;
  ...
  const gstAmount = Math.round(
    membershipPrice * 0.18
  );

  const totalAmount =
    membershipPrice + gstAmount;
  ...
  /* =======================================================
     ...
     IMPORTANT:
     Is function ko aapke actual login system ke according
     modify kiya ja sakta hai.

     Filhaal ye common localStorage/sessionStorage
     login values check karega.
  ======================================================= */
  ...
  const handleLogin = () => {
    ...
    /*
      Current payment declaration URL save kar rahe hain
      taki login ke baad user wapas aa sake.
    */
    ...
    /*
      Agar aapka Login route different hai
      to /services/login ko change kar dena.
    */

    router.push(
      `/services/login?redirect=${encodeURIComponent(
        returnUrl
      )}`
    );
  };
  ...
  const handleSignup = () => {
    ...
    /*
      Agar signup page ka route different hai
      to /services/signup ko change karna.
    */

    router.push(
      `/services/signup?redirect=${encodeURIComponent(
        returnUrl
      )}`
    );
  };
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-3xl border border-[#dce9cf] bg-white p-5 shadow-sm dark:border-emerald-900 dark:bg-[#0d1d14] sm:p-6">
                ...
                >
                  ...
                  >
                    {allChecked
                      ? "All declarations accepted. You can now proceed to payment."
              ...
              <div className="sticky top-5 overflow-hidden rounded-3xl border border-[#dce9cf] bg-white shadow-lg dark:border-emerald-900 dark:bg-[#0d1d14]">
                ...
                <div className="p-5">
                  ...
                  <button
                    ...
                    className={`mt-6 flex w-full items-center justify-center gap-2 rounded-full px-5 py-4 text-sm font-black transition-all duration-300 ${
                      allChecked &&
                      plan.planId &&
                      membershipPrice >
                        0
          ...
          >
            ...
            <div className="p-6">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-full bg-[#064627] px-5 py-3.5 text-sm font-black text-white shadow-md transition hover:-translate-y-0.5 hover:bg-[#095936] hover:shadow-lg"
              >
              ...
              <div className="mt-4 flex items-center justify-center gap-2">
                <ShieldCheck className="h-4 w-4 text-[#17643d] dark:text-emerald-400" />
